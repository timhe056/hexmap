...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/tutorial-image.jpg)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/prefab.png)

Add a reference to this prefab to HexFeatureManager and hook it up.

![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/inspector.png)

```
public Transform wallTower;</pre>
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/tower-instances.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/towers-rotated.png)

How does setting Transform.right work?

It uses the Quaternion.FromToRotation method to derive the rotation. Here is the code of the property.
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/corner-towers.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/fewer-towers.png)

![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/slopes-with-towers.png)

```
public const float wallTowerThreshold = 0.5f;</pre>
					...
					<section>
						...
						<pre translate="no">				bool hasTower = false;
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/slopes-without-towers.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/towers-floating.png)

Actually, sloped walls can float as well, although it is not as noticeable as the towers.

![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/wall-floating.png)
...
We also have to adjust the tower prefab, as its base will now end up one unit below ground. So increase the base cube's height by one unit, and adjust the local position of the cubes accordingly.

![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/towers-grounded.png)

![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/wall-towers/wall-grounded.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/inspector.png)

```
public Transform wallTower, bridge;</pre>
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/straight-bridges.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/straight-bridges-roads.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/curving-bridges.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/curving-bridges-roads.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/varying-river-width.png)
...
```
public const float bridgeDesignLength = 7f;</pre>
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/varying-bridge-length.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/prefab.png)

![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/bridges/arc-bridges.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/castle.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/ziggurat.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/megaflora.png)

Add an array to HexFeatureManager to keep track of these prefabs.

![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/inspector.png)

```
public Transform[] special;</pre>
					...
					<section>
						...
						<pre translate="no">	int specialIndex;
```
...
Add a slider to the UI to control the special feature. As we have three features, set the slider's range to 0&ndash;3. Zero means no feature, one is a castle, two is a ziggurat, and three is megaflora.

![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/ui.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/features.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/on-rivers.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/on-roads.png)
...
If we're setting the index to zero, that means the cell already had a special feature. Thus, it didn't have any roads. So we don't need to use a different approach.
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/on-features.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-11/special-features/in-water.png)
