...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/tutorial-image.jpg)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/splat-triangle.png)

Does the splat map triangle always sum to one?

Yes. The three color channels define a trilinear interpolation across the surface of the triangle. They function as barycentric coordinates. For example, you have the three possible permutations of (1, 0, 0) at the corners, variants of (&frac12;, &frac12;, 0) in the middle of the edges, and (&frac13;, &frac13;, &frac13;) at the center.
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/splat-configurations.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/red-center.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/red-adjacent-to-river.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/red-rivers.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/red-green-edges.png)

Isn't the hard transition between red and green a problem?

Although the edge transition is from red to green, the cell centers on both sides are red. So there appears to be a discontinuity on one side of the edge. However, this is just the splat map. The colors of adjacent triangles do not need to be linked to the same textures. In this case, what corresponds with green on one side corresponds with red on the other side.

Note that this wouldn't be possible if the triangles shared vertices.
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/red-green-edge-terraces.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/red-green-blue-corners.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/red-green-blue-corner-terraces.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/blending-three-types/red-green-blue-corner-terraces-cliffs.png)
...
Modern GPUs support them, but older and some mobile ones might not. Here's the list of supported platforms, according to the Unity docs.
...
The advantage of using an asset is that we don't have to spend time in play mode to create the texture array. We don't have to include the individual textures in builds, only to copy them and then no longer use them.
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/wizard.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/wizard-textures.png)

```
public Texture2D[] textures;</pre>
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/sand.png)

![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/grass.png)

![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/mud.png)

![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/stone.png)

![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/snow.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/wizard-texture-selection.png)

![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/hierarchy.png)

After creating the texture array asset, select it and give it a look in the inspector.

![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/inspector.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/texture-arrays/default-sand.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/selecting-textures/using-terrain-types.png)
...
Yes. When using a constant index, color[0] is equivalent to color.r. And color[1] is equivalent to color.g, and so on.
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/selecting-textures/textured-terrain.png)
...
![](https://catlikecoding.com/unity/tutorials/hex-map/part-14/selecting-textures/terrain-choices.png)
